...
namespace DBLib
{
	...
	void CDBValue::SetValue(int ValueType, LPCVOID pData, size_t DataSize, UINT DitigalSize)
	{
		Destory();
	...
	void CDBValue::SetEmptyValue(int ValueType, size_t DataSize, UINT DitigalSize)
	{
		Destory();
		m_ValueType = ValueType;
	...
	size_t CDBValue::GetLength()
	{
		return m_DataSize;
	}

	UINT CDBValue::GetDigitalLength()
	{
		return m_DigitSize;
	}
